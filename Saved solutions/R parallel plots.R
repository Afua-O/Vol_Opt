...
setwd("C:/Users/aow001/Dropbox/PhD/Work/4. Hydro-economic modelling/Python optimisation/Vol_Opt/Saved solutions/1984_clam")
print(getwd())
...
ggparcoord(data=data,
  ...
  scale_color_manual(values = c("#CC0033", "#00CC99", "#6600FF", "#E8E8E8", "#E8E8E8", "#E8E8E8")) +
  theme_ipsum()+
  theme(
...
ggparcoord(data=data,
  ...
  scale_color_manual(values = c("#CC0033", "#33CCCC", "#E8E8E8", "#E8E8E8", "#E8E8E8")) +
  theme_ipsum()+
  theme(
    legend.position= "right",#"none",
    legend.title = element_blank(),
