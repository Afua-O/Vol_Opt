...
setwd("C:/Users/aow001/Dropbox/PhD/Work/4. Hydro-economic modelling/Python optimisation/Vol_Opt/Saved solutions/1984_clam_Kp")
      #29y_clam/seed10")
print(getwd())
...
data$Name <- factor(data$Name, levels = c("Best hydropower-Ak","Best hydropower-Kp", "Best environment", "Best irrigation", "Other solutions", "Min", "Max"))
...
ggparcoord(data=data,
  ...
  scale_color_manual(values = c("#CC3366", "#FF6600", "#00CC99", "#6600FF", "#E8E8E8", "#E8E8E8", "#E8E8E8")) +
  theme_ipsum()+
  theme(
